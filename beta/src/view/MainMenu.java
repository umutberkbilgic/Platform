...
public class MainMenu extends BasicGameState{
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
        ...
        leaderBoardButton = new Button((int) (screen_width*(0.28)), (int) (screen_height*0.4), buttonwidth, buttonheight, "data/img/leader.png", 0);
        //achievementsButton  = new Button((int) (screen_width*(0.28)), (int) (screen_height*0.525), buttonwidth, buttonheight, "data/img/achi.png", 0);
        settingsButton  = new Button((int) (screen_width*(0.28)), (int) (screen_height*0.525), buttonwidth, buttonheight, "data/img/settings.png", 0);
	}
